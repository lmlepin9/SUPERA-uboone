...
/** \addtogroup ModularAlgo
    ...
    @{*/
#ifndef GALLERY_FMWK_SUPERA_UBOONE_RAWDIGIT_H
#define GALLERY_FMWK_SUPERA_UBOONE_RAWDIGIT_H
...
class ubooneRawDigit : public SuperaModuleBase {

public:

    /// Default constructor
    ubooneRawDigit(){_name = "ubooneRawDigit";_verbose=false;}
