#ifndef GALLERY_FMWK_SUPERA_UBOONE_WIRE_CXX
#define GALLERY_FMWK_SUPERA_UBOONE_WIRE_CXX
...
void ubooneWire::initialize(){

}


void ubooneWire::slice(gallery::Event* ev, larcv3::IOManager & io) {
  ...
  auto & event_image2d = io.get_data<larcv3::EventTensor2D>("uboonewire");
