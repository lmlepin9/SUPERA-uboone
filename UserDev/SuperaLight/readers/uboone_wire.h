...
#ifndef GALLERY_FMWK_SUPERA_UBOONE_WIRE_H
#define GALLERY_FMWK_SUPERA_UBOONE_WIRE_H
...
class ubooneWire : SuperaModuleBase {

public:

    /// Default constructor
    ubooneWire(){_name = "ubooneWire";_verbose=false;}
