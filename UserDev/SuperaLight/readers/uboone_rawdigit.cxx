#ifndef GALLERY_FMWK_SUPERA_UBOONE_RAWDIGIT_CXX
#define GALLERY_FMWK_SUPERA_UBOONE_RAWDIGIT_CXX
...
void ubooneRawDigit::initialize() {
    std::cout << "Calling initialize in subclass " << std::endl;
}

void ubooneRawDigit::slice(gallery::Event* ev, larcv3::IOManager & io) {
  ...
  auto & event_image2d = io.get_data<larcv3::EventTensor2D>("uboonedigit");
